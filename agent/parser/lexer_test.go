...
func TestASLLexer(t *testing.T) {
	...
	if !compareTokens(tokes, []token{token{terminal: 57348, line: 1, start: 0, source: "value"}, token{terminal: 57356, line: 1, start: 5, source: ":"}, token{terminal: 57348, line: 1, start: 6, source: "series"}, token{terminal: 57357, line: 1, start: 12, source: "("}, token{terminal: 57346, line: 1, start: 14, source: "test"}, token{terminal: 57358, line: 1, start: 19, source: ")"}, token{terminal: 57355, line: 1, start: 20, source: "."}, token{terminal: 57348, line: 1, start: 21, source: "aggregate"}, token{terminal: 57357, line: 1, start: 30, source: "("}, token{terminal: 57346, line: 1, start: 32, source: "avg"}, token{terminal: 57354, line: 1, start: 36, source: ","}, token{terminal: 57346, line: 1, start: 38, source: "7d"}, token{terminal: 57354, line: 1, start: 41, source: ","}, token{terminal: 57346, line: 1, start: 43, source: "10m"}, token{terminal: 57358, line: 1, start: 47, source: ")"}}) {
